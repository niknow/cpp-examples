...
/* You can declare a class before you define it. This is
called a forward declaration and is sometimes neccessary
to avoid circles. */

class some_class; 


class employee {                        // This is how one declares classes.
...
// Declared member functions can be defined like this.
