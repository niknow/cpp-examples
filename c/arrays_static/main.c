/*#pragma warning( disable : 4789 ) comment in to provoke buffer overflow below */
#include <stdio.h>
#include <stdlib.h>
...
int main(int argc, char* argv[])
{
    ...
    x[3] = 1;        /* Even though this might accidentally work. Never do that!*/
    ...
    printf("3: %i\n", x[5]);    /* Danger! This accesses memory in an unknown state. Never do that! */
