...
int main(int argc, char* argv[])
{
    ...
    a = (int*)malloc(n * sizeof(int));      /* Dynamically allocate memory. */
                                            /* Malloc needs the size of the memory to be allocated in bytes. It is advisable
                                                to calculate this using sizeof. The return value is of type void*, which is
                                                why it needs to be type casted down to (int*). */
    ...
    a = (int*)calloc(n, sizeof(int));       /* Dynamically allocate memory and initialize. */
