...
/* Functions allow you to split up more complex code into smaller pieces that
   are easier to understand. That makes you code more readable, easier to debug,
...
/* A functions can be declared first like this (and been given a definition 
...
/* A function can return a new array like this. */
